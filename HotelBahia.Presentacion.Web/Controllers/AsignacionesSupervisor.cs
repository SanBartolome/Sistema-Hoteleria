...
namespace HotelBahia.Presentacion.Web.Controllers
{
    ...
    public class AsignacionesSupervisorController : BaseController
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                new SqlParameter("@IdRol", (int)RolEnum.Supervisor)
            };
            ...
            var habitaciones = _context.Habitacion.Include(a => a.AsignacionHabitacion).Where(a => a.AsignacionHabitacion.Count == 0 || !a.AsignacionHabitacion.Any(x => x.RolId == (int)RolEnum.Supervisor));
